...
setup(name='LigPargen',
      ...
      install_requires=[
          'markdown',
          'numpy',
          # PyPI "pybel" is the wrong package; use Open Babel bindings (conda: openbabel; pip: openbabel-wheel).
          'openbabel-wheel',
      ],
      entry_points={
      ...
      # Upstream pins 3.7 only; relax locally for macOS / newer Python (test before publishing).
      python_requires='>=3.7',
      zip_safe=False)
